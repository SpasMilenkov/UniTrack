...
public class AuthControllerTests
{
    ...
    public AuthControllerTests()
    {
        ...
        _controller = new AuthController(_fakeAuthService, fakeEmailService, mapper);
        ...
        A.CallTo(() => _fakeHttpContext.Request).Returns(fakeHttpRequest);
        A.CallTo(() => fakeHttpRequest.Scheme).Returns("http");
